 ...
 *     @OA\Property(property="thumb", type="string", example="http://api.com/image.jpg"),
 ...
 *     @OA\Property(property="number_pages", type="int", example="200"),
 *     @OA\Property(property="language", type="string", example="en"),
 *     @OA\Property(property="user", ref="#/components/schemas/User"),
 *     @OA\Property(property="category", ref="#/components/schemas/Category"),
 *     @OA\Property(property="publisher", ref="#/components/schemas/Publisher"),
 ...
 *     description="Standard form request for books.",
...
*         @OA\Schema(required={"thumb", "title", "author", "isbn", "description", "number_pages", "language", "category", "publisher"}),
*      }      
* )
*/
class BookStoreRequestAnnotation {}

/**
* @OA\Schema(
*      schema="BookUpdateRequest"
*      title="BookUpdateRequest",
*      description="A form request to update a book.",
*      allOf={
*         @OA\Schema(ref="#/components/schemas/BookFormRequest"),
*         @OA\Schema(required={"title", "author", "isbn", "description", "number_pages", "language", "category", "publisher"}),
*      }      
* )
*/
class BookUpdateRequestAnnotation {}
 ...
 *      @OA\Property(property="data", type="array", @OA\Items(ref="#/components/schemas/Book")),
 *      @OA\Property(ref="#PaginateLinksResponse")
 * )
 */
